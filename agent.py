...
def get_model():
    ...
    # For custom base URLs, we need to set environment variables
    # that OpenAI SDK will pick up
    ...
    # Return model - will use environment variables
    return OpenAIChatModel(llm)
